...
const PlanTitle = ({
  ...
  <h1
    className={cn(
      "text-[clamp(1.7rem,10vw,3rem)] font-bold leading-[1] sm:text-5xl",
      className,
    )}
  >
    {children}
...
const PlanPrice = ({
  ...
  <div
    style={{ lineHeight: "1" }}
    className={cn(
      "text-[clamp(1.7rem,10vw,3rem)] font-bold sm:text-5xl",
      className,
    )}
  >
    {children}
...
const PlanDescription = ({
  ...
  <p
    className={cn(
      "text-[clamp(0.1rem,20vw,1.25rem)] font-bold sm:text-2xl",
      className,
    )}
  >
    {children}
